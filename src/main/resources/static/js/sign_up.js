document.addEventListener("DOMContentLoaded", function () {
	...
	// let bringNumberBtn = document.querySelector(".bring_number_btn");
	// console.log(bringNumberBtn);
	// let authenticationForm = document.querySelector(".authentication_form");
	// bringNumberBtn.addEventListener("click",()=> {
