                ...
                <div class="detail_left_from">
                    ...
                    <span style="color: var(--primary_02);">
                        ...
                        <div class="detail_res_form">
                            ...
                            <div class="form-group detail_group_padding">
                                <p><label for="gender" class="detail_group_maginb">성별</label></p>
                                <div class="btn detail_input" id="male">남자</div>
                                <div class="btn detail_input" id="female">여자</div>
                                <input type="hidden" id="gender" name="gender" value="">
                            </div>
                            <div class="form-group detail_group_padding">
                                <p><label for="birth" class="detail_group_maginb">생년월일</label></p>
