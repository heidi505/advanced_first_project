                    ...
                    <div class="admin_form_box">
                        ...
                        <ul class="admin_form_area">
                            <li class="admin_form_textfield">
                                ...
                                <input type="text" id="noticeTitle" class="form-control" placeholder="제목을 입력해주세요"
                                       name="noticeTitle">
                            </li>
                            <li class="admin_form_textfield">
                                <label for="noticeCont" class="form-label">내용</label>
                                <div><textarea class="form-control" name="noticeCont" id="noticeCont" cols="30" rows="10" placeholder="내용을 입력해주세요"></textarea></div>
                            </li>
                        </ul>
