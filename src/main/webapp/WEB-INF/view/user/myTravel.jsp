								...
								<ul class="my_trip_item">
									<li class="my_trip_content">
										<ul class="my_trip_content_top">
											<li><span class="before_payment_label"> <c:choose>
											...
											<li><a href="/reservation/detail/${list.reservationNum}">예약
													상세 보기 <img src="/images/icons/detail_arrow.svg"
													alt="예약 상세보기">
											</a></li>
										</ul>
											...
											<li>
												<div class="my_trip_ticket_img">
													<div class="my_trip_ticket_bg">
														<span class="trip_left">${list.departureCity}</span> <span
															class="trip_right">${list.arrivalCity}</span>
													</div>
												</div>
											</li>
										</ul>
										<ul class="my_trip_content_btm">
											...
											<li><img src="/images/icons/my_trip_arrow.svg" alt="화살표">
											</li>
											<li>
												<p>${aTime}</p>
									...
									<li class="reservation_cancle">
										<div class="reservation_cancle_btn mb-3">
											<a href="/reservation/cancel-modal/${list.reservationNum}">예약
												취소하기</a>
										</div>
							...
							<ul class="my_trip_item">
								<li class="my_trip_content">
									<ul class="my_trip_content_top">
										...
										<li><a href="#">예약 상세 보기 <img
												src="/images/icons/detail_arrow.svg" alt="예약 상세보기">
										</a></li>
									</ul>
									<ul class="my_trip_content_mid">
										<li class="my_trip_content_tit">
								...
								<li class="my_trip_content">
									...
									<ul class="my_trip_content_mid">
										...
										<li>
											<div class="my_trip_ticket_img">
												<div class="my_trip_ticket_bg">
													<span class="trip_left">PUS</span> <span class="trip_right">NRT</span>
												</div>
											</div>
										</li>
									</ul>
