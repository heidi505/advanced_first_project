        ...
        <div class="container">
            ...
            <div class="left_profile float-start w-25">
                <div class="picture text-center mb-4 mx-4 p-5 border">
                    <img src="/images/git_img.png" alt="" class="profile_image mx-auto d-block"/>
                    <label for="form-label" class="my-4 fs-5">홍길동</label>
                    <p class="left_profile_text">프로필 관리</p>
                </div>
                <div class="coupon_profile col ">
                    <div class="coupon_count border mx-auto m-2 p-4 w-85 ">내 쿠폰<a class="color_primary02 float-end me-2"
                                                                                  href="/user/coupon">0장 ></a></div>
                </div>
                <!-- 쿠폰 창 끝 -->
            </div>
            <!-- 여기까지 left-profile -->
            ...
            <div class="profile_box float-end d-flex flex-column border p-5 w-75">
                <div>
                    <button class="border rounded px-4 py-2 float-end me-5">편집</button>
                </div>
