        ...
        <div class="section">
            ...
            <div class="left_profile float-start w-25">
                <div class="picture text-center mb-4 mx-4 p-5 border">
                    <img src="/images/git_img.png" alt="" name=""
                         class="profile_image mx-auto d-block"/> <label for="form-label" class="my-4 fs-5">홍길동</label>
            ...
            <div class="coupon_box d-flex flex-column border w-60">
                ...
                <div class="p-2 mt-5">
                    ...
                    <input type="text" id="coupon_insert" name="coupon" class="form-control d-inline w-81 ms-3 me-1"/>
